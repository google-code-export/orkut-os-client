...
public class PhotosTest extends TestCase {
  ...
  private Map<String, Photo> getKnownPhotos() {
    ...
    Photo photo = new Photo(ID_SELF, ALBUM_ID, "1257484193076");
    ...
    photo = new Photo(ID_SELF, ALBUM_ID, "1257484193077");
    ...
    photo = new Photo(ID_SELF, ALBUM_ID, "1257484239963");
    ...
    photo = new Photo(ID_SELF, ALBUM_ID, "1257484260418");
    ...
    photo = new Photo(ID_SELF, ALBUM_ID, "1257484260419");
    ...
    photo = new Photo(ID_SELF, ALBUM_ID, "1257484285207");
    ...
    photo = new Photo(ID_SELF, ALBUM_ID, "1257484285208");
    ...
    photo = new Photo(ID_SELF, ALBUM_ID, "1257484303529");
    ...
    photo = new Photo(ID_SELF, ALBUM_ID, "1257484331190");
