...
# build archive
$HG archive -X "scripts/" --rev $REV --type "tbz2" "../orkut-os-client-$RELEASE_NAME-$REV.tar.bz2"

# go back to the current directory
cd -
mv "$TMP_TARGET/orkut-os-client-$RELEASE_NAME-$REV.tar.bz2" .

echo cleaning up
rm -rf $TMP_TARGET

echo Release package prepared as orkut-os-client-$RELEASE_NAME-$REV.tar.bz2
